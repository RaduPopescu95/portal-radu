  ...
  const missionContent = [
    {
      id: 1,
      icon: "flaticon-user",
      number: "Oferte personalizate:",
      meta: "Fiecare ofertă este ajustată cu un discount special pentru membri.",
    },
    {
      id: 2,
      icon: "flaticon-tick",
      number: "Validare manuală:",
      meta: "Fiecare anunț și fiecare înscriere ca membru sunt validate manual, asigurând astfel o calitate superioară și siguranța informațiilor prezentate.",
    },
  ];
