...
const CreateList = () => {
  ...
  const [selectedOfferType, setSelectedOfferType] = useState("Oferta cu discount procentual general"); // Starea pentru select
  ...
  <div className="my_profile_setting_input form-group">
    ...
    <input type="text" className="form-control" id="propertyTitle" readOnly value="Primiti 20% discount la toate produsele noastre"/>
  </div>
</div>
      {/* End .col */}
    ...
    <div className="row mt-2">
      <div className="col-sm-auto">
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="Silver" id="fidelityGradeSilver" checked onClick={(e) => e.preventDefault()} />
          <label className="form-check-label" htmlFor="fidelityGradeSilver">
            Silver
          </label>
        </div>
      </div>
      <div className="col-sm-auto">
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="Gold" id="fidelityGradeGold" onClick={(e) => e.preventDefault()} />
      ...
      <div className="col-sm-auto">
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="Platinum" id="fidelityGradePlatinum" onClick={(e) => e.preventDefault()} />
          <label className="form-check-label" htmlFor="fidelityGradePlatinum">
            Platinum
          </label>
        </div>
      </div>
